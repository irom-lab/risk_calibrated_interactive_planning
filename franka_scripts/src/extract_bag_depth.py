...
class ConvertEnv(object):
    def __init__(self):
        ...
        # rospy.Subscriber('cloudify/points', 
        #                 PointCloud2,
    ...
    def run(self):
        ...
        for i, bag_path in enumerate(bag_path_list):
            ...
            for topic, msg, t in bag.read_messages(topics=['depth']):
                print('Frame: ', cnt)
                cnt += 1
                ...
                cv_img = cv_bridge.imgmsg_to_cv2(msg, desired_encoding='16UC1') # (576,640)
